  ...
  return (
    <div className="relative flex items-center gap-20 py-40 px-40">
      ...
      <div ref={trusttext} className="relative w-3/5 flex flex-col gap-7">
        <h1 className="text-white font-figtree font-medium text-[54px] leading-none">
        ...
        <p className="font-figtree text-white text-lg">
          ...
          sports. Like no other we know how to find the sweet spots between
          brands and sports culture, which makes us the specialists in our game.
        </p>
        <p className="font-figtree text-white text-lg">
          Our goal is to create talk-worthy and head-turning campaigns with
          outstanding results. Or as we like to say: Rockets for brands that
          dare to stand out. Nothing less.
        </p>
      </div>
    </div>
  );
