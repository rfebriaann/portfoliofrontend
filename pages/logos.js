...
export default function Logos() {
    ...
    useEffect(()=> {
        gsap.fromTo(logosatu.current, 1, 
            {
                scrollTrigger:{
        ...
        gsap.fromTo(logotiga.current, 1, 
            {
                scrollTrigger:{
        ...
        gsap.fromTo(logoempat.current, 1, 
            {
                scrollTrigger:{
        ...
        gsap.fromTo(logolima.current, 1, 
            {
                scrollTrigger:{
        ...
        gsap.fromTo(logoenam.current, 1, 
            {
                scrollTrigger:{
    ...
    return (
        <div className="relative flex items-center justify-center gap-36 px-40 py-36">
            <div className="absolute p-10" ref={logosatu}>
                <Image
                    className='z-10'
